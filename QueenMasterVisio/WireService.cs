...
namespace QueenMasterVisio
{
    internal class WireService
    {
        public static readonly List<Wire> wires = new List<Wire>()
        {
            ...
            new Wire(2,"Ex",      true, "Ethernet wires","THEMEGUARD(RGB(0,176,240))",      false, "FTP Cat 5E","5v"        ),
            new Wire(3,"Rx",      true, "RS485 wires","THEMEGUARD(RGB(112,48,160))",        false, "FTP Cat 5E","12v"       ),
            ...
            new Wire(6,"Sx",      true, "Sensor wires","THEMEGUARD(RGB(0,176,80))",         true,  "FTP Cat 5E", "12v"      ),
            new Wire(7,"Yx",      true, "Emergency buttons","THEMEGUARD(RGB(185,185,185))", false, "3 x 0.75",   "12v"      ),
            new Wire(8,"Vx",      true, "CCTV wires","THEMEGUARD(RGB(204,194,217))",        false, "FTP Cat 5E","36v-57v"   ),
