...
namespace QueenMasterVisio
{
    internal class WireService
    {
        public static readonly List<Wire> wires = new List<Wire>()
        {
            ...
            new Wire(1,"Px",      true, "230v wires","THEMEGUARD(RGB(255,0,0))",            false, "3x2.5",   "230v"      ),
            ...
            new Wire(4,"Dx",      true, "12v wires","THEMEGUARD(RGB(255,235,0))",           false, "3x1.5",   "12v"       ),
            new Wire(5,"Cx",      true, "12v signal wires","THEMEGUARD(RGB(255,192,0))",    true,  "3x1.5",    "12v"      ),
            new Wire(6,"Sx",      true, "Sensor wires","THEMEGUARD(RGB(0,176,80))",         true,  "UTP Cat 5E", "12v"      ),
            new Wire(7,"Yx",      true, "Emergency buttons","THEMEGUARD(RGB(185,185,185))", false, "3x1.5",   "12v"      ),
            new Wire(8,"Vx",      true, "CCTV wires","THEMEGUARD(RGB(204,194,217))",        false, "UTP Cat 5E","36v-57v"   ),
            new Wire(9,"Lx",      true, "Light wires","THEMEGUARD(RGB(0,32,96))",           false, "3x1.5",   "12v"       ),
            new Wire(10,"Ax",     true, "Sound wires","THEMEGUARD(RGB(234,112,13))",        false, "2x1.5",   "24v"       ),
